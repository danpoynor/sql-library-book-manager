  ...
  Book.init(
    {
      ...
      author: {
        ...
        validate: {
          ...
          len: {
            args: [1, 255],
            msg: '"Author" must be between 3 and 255 characters'
          }
        }
      },
      genre: {
        type: DataTypes.STRING,
        allowNull: true,
        defaultValue: 'Unknown Genre' // set a default value
      },
      year: {
        ...
        validate: {
          ...
          len: {
            args: [1, 4],
            msg: '"Year" must be between 1 and 4 digits long'
          }
        }
      }
    },
    {
      ...
      sequelize,
      // modelName can useful when there are multiple models/tables with relationships
      modelName: 'Book'
    }
  );
